	 ...
	 }else
	 {
 		...
 		}else
 		{
		 	...
		 	}else
		 	{
		 		...
		 		query("INSERT INTO history (user_id, symbol, status, shares, price) VALUES($id, '$symbol', 'BUY', $shares, $price)");
		 		render("../views/buy.php", ["title" => "Buy", "stock" => $stock, "cost" => $cost, "shares" => $shares]);
		 	}
	 	}
	 }
} 
